...
def _pip_install_via_requirements_2(prefix, specs, args, *_, **kwargs):
    """
    ...
    """
    url_scheme = args.file[0].split("://", 1)[0]
    if url_scheme in CONDA_SESSION_SCHEMES:
        pip_workdir = None
    else:
        try:
            pip_workdir = op.dirname(op.abspath(args.file[0]))
...
def install_2(*args, **kwargs):
    with get_spinner("Installing pip dependencies"):
        return _pip_install_via_requirements_2(*args, **kwargs)
